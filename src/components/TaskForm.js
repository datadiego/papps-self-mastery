        ...
        <div className="container"> {/* Added container div */}
            <div className="app-container">
                <form className="task-form" onSubmit={handleSubmit}>
                    <button className="answer-questions-button gold-button"> DAILY QUESTIONS</button>
                    ...
                    <button type="submit" className="answer-questions-button gold-button" disabled={taskSubmitted}>Submit</button>
                </form>
            </div>
        </div>
    );
